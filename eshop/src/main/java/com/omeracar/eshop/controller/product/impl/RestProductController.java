package com.omeracar.eshop.controller.product.impl;

import com.omeracar.eshop.controller.product.IRestProductController;
...
public class RestProductController extends RestBaseController implements IRestProductController {
    ...
    @Override
    @GetMapping("/getAll")
    public ResponseEntity<RootEntity<Page<ProductResponseDto>>> getAllProducts(Pageable pageable) {
